...
class AccessibilityViewEmbedder {
    ...
    public static class c {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof c) {
                c cVar = (c) obj;
                return this.f334b == cVar.f334b && this.f333a.equals(cVar.f333a);
            }
            return false;
        }

        public int hashCode() {
            return ((this.f333a.hashCode() + 31) * 31) + this.f334b;
        }
    }
    ...
    public AccessibilityNodeInfo createAccessibilityNodeInfo(int i) {
        ...
        if (cVar == null || !this.embeddedViewToDisplayBounds.containsKey(cVar.f333a) || cVar.f333a.getAccessibilityNodeProvider() == null || (createAccessibilityNodeInfo = cVar.f333a.getAccessibilityNodeProvider().createAccessibilityNodeInfo(cVar.f334b)) == null) {
            return null;
        }
        return convertToFlutterNode(createAccessibilityNodeInfo, i, cVar.f333a);
    }
    ...
    public boolean onAccessibilityHoverEvent(int i, MotionEvent motionEvent) {
        ...
        Rect rect = this.embeddedViewToDisplayBounds.get(cVar.f333a);
        ...
        return cVar.f333a.dispatchGenericMotionEvent(MotionEvent.obtain(motionEvent.getDownTime(), motionEvent.getEventTime(), motionEvent.getAction(), motionEvent.getPointerCount(), pointerPropertiesArr, pointerCoordsArr, motionEvent.getMetaState(), motionEvent.getButtonState(), motionEvent.getXPrecision(), motionEvent.getYPrecision(), motionEvent.getDeviceId(), motionEvent.getEdgeFlags(), motionEvent.getSource(), motionEvent.getFlags()));
    }

    public boolean performAction(int i, int i2, Bundle bundle) {
        AccessibilityNodeProvider accessibilityNodeProvider;
        c cVar = this.flutterIdToOrigin.get(i);
        if (cVar == null || (accessibilityNodeProvider = cVar.f333a.getAccessibilityNodeProvider()) == null) {
            return false;
        }
        return accessibilityNodeProvider.performAction(cVar.f334b, i2, bundle);
    }
