...
public final class a {
    ...
    public static final String f173a = c.class.getName() + ".aot-shared-library-name";

    /* renamed from: b  reason: collision with root package name */
    public static final String f174b = c.class.getName() + ".vm-snapshot-data";
    ...
    public static b e(Context context) {
        ...
        return new b(d(a2.metaData, f173a), d(a2.metaData, f174b), d(a2.metaData, c), d(a2.metaData, d), c(a2, context), a2.nativeLibraryDir, b(a2.metaData, "io.flutter.automatically-register-plugins", true));
    }
