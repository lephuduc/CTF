...
public class b {
    ...
    private final io.flutter.embedding.engine.renderer.a f102a;

    /* renamed from: b  reason: collision with root package name */
    private final n f103b = n.a();
    ...
    private void a(MotionEvent motionEvent, int i, int i2, int i3, Matrix matrix, ByteBuffer byteBuffer) {
        ...
        long d5 = this.c ? this.f103b.c(motionEvent).d() : 0L;
    ...
    public boolean d(MotionEvent motionEvent) {
        ...
        if (z && z2) {
            ...
            if (allocateDirect.position() % 232 == 0) {
                this.f102a.g(allocateDirect, allocateDirect.position());
                return true;
            }
    ...
    */
    public boolean f(android.view.MotionEvent r13, android.graphics.Matrix r14) {
        ...
        L6f:
            ...
            int r13 = r13 % 232
            if (r13 != 0) goto L81
            io.flutter.embedding.engine.renderer.a r13 = r12.f102a
            int r14 = r1.position()
            r13.g(r1, r14)
            return r10
        L81:
